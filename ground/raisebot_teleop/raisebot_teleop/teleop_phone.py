#!/usr/bin/env python3
"""
RaiseBot — phone teleop via a tiny Flask web app.
...
SNAPSHOT_DIR = os.path.expanduser('~/raisebot_snapshots')
...
def main():
    ...
    templates_dir = os.path.join(
        get_package_share_directory('raisebot_teleop'), 'templates'
    )
    app = Flask('raisebot_teleop_phone', template_folder=templates_dir)
