...
"""
AgriBot — thin helpers to talk to Gazebo Harmonic (gz-sim 8) from Python.
...
# NOTE: TOP-LEVEL MODELS (agribot_robot, spawned tomatoes) are reported in the
# WORLD frame; links inside a model are relative to that model. So callers use
# get_model_world_pose('agribot_robot') + TF (base_link→gripper) for the tool.
