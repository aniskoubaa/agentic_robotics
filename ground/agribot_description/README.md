...
URDF/xacro for the AgriBot robot platform: **Husky A200 + UR5e + Robotiq 2F-85 + RealSense D435**.

## Contents (to be filled)

- `urdf/agribot_robot.urdf.xacro` — top-level robot, composes upstream macros
