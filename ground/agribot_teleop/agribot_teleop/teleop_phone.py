#!/usr/bin/env python3
"""
AgriBot — phone teleop via a tiny Flask web app.
...
SNAPSHOT_DIR = os.path.expanduser('~/agribot_snapshots')
...
def main():
    ...
    templates_dir = os.path.join(
        get_package_share_directory('agribot_teleop'), 'templates'
    )
    app = Flask('agribot_teleop_phone', template_folder=templates_dir)
