#!/usr/bin/env python3
"""
RaiseBot — Lab 1, Script 08 — call the YOLO object detector.
...
║     raisebot_tools/raisebot_tools/detector_server.py                    ║
║                                                                           ║
...
Then run this client:
    ...
    ros2 run raisebot_labs 08_call_detector.py    # or:  ros2 run raisebot_labs 08_*
"""
    ...
    for key, (label, srv_name) in ACTIONS.items():
        if not clients[key].wait_for_service(timeout_sec=SERVER_TIMEOUT):
            node.get_logger().error(
                ...
                f'    ros2 run raisebot_tools detector_server'
            )
