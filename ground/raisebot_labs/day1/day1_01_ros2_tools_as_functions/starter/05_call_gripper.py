#!/usr/bin/env python3
"""
RaiseBot — Lab 1, Script 05 — interactive gripper menu.
...
║     raisebot_tools/raisebot_tools/gripper_server.py                     ║
║                                                                           ║
...
Then run this client:
    ...
    ros2 run raisebot_labs 05_call_gripper.py    # or:  ros2 run raisebot_labs 05_*
"""
    ...
    for key, (label, srv_name) in ACTIONS.items():
        if not clients[key].wait_for_service(timeout_sec=SERVER_TIMEOUT):
            node.get_logger().error(
                ...
                f'    ros2 run raisebot_tools gripper_server'
            )
