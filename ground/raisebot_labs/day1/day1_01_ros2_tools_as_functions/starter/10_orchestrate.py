#!/usr/bin/env python3
"""
RaiseBot — Lab 1, Script 10 — the orchestrator (LLM tool-use loop).
...
The `ros2 run raisebot_labs 10_*` alias starts the servers for you. Manual:
    ...
    ros2 run raisebot_labs 10_orchestrate.py     # or:  ros2 run raisebot_labs 10_*
...
def main():
    ...
    BANNER = """
┌─── RaiseBot · Orchestrator (LLM agent) ──────────────────┐
