#!/usr/bin/env python3
"""
RaiseBot — Lab 1, Script 01 — interactive drive menu.
...
Run while `agr-sim ground` is up:
    ...
    ros2 run raisebot_labs 01_drive_forward.py    # or:  ros2 run raisebot_labs 01_*
"""
...
def main():
    ...
    # listens to it via the DiffDrive plugin in raisebot_gazebo.urdf.xacro.
