...
"""
RaiseBot — Lab 2.1, Script 04 — ship your dataset to the shared GPU server.

WHAT  Pack the LeRobot dataset you recorded with Script 03 into one archive and
      POST it to the shared course server, tagged with your team id + task. The
...
Run after recording:
    ...
    ros2 run raisebot_labs 04_upload.py --task A --team team07 \
        --server http://gpu-box.lan:8000
    # or:  ros2 run raisebot_labs 04_* ...
"""
...
def main():
    ap = argparse.ArgumentParser(description='RaiseBot dataset uploader')
