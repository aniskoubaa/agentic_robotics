...
ros2 run raisebot_labs 05_* --episodes 50 --team ref --hf-user raiseschool     # → 50/50 grasp OK, ~28 min (scan choreography)
ros2 run raisebot_labs 06_* --task C --team ref --episode 0 --spawn            # → grasped tomato_red_0 ... released
