...
"""
RaiseBot — Lab 2.2 — the VLA executor (command the robot by speaking).
...
PREREQUISITES (three things):
    ...
    2. the grasp server: ros2 run raisebot_tools grasp_server    (grasp_d3)
...
def main():
    ap = argparse.ArgumentParser(description='RaiseBot VLA executor')
