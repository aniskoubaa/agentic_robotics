...
```
 ...
 camera into LeRobot format                     learns to copy the mapping
        ...
        RaiseBot/datasets/…            ──►    ~/raise_checkpoints/smolvla_C_ref
```
...
`RaiseBot/datasets/raiseschool__raise_ripeness_sort_ref/`.
...
~/raise_venvs/lerobot/bin/lerobot-train \
  ...
  --dataset.root=<repo>/RaiseBot/datasets/raiseschool__raise_ripeness_sort_ref \
...
`ros2 run raisebot_labs 03_* / ros2 run raisebot_labs 05_* / ros2 run raisebot_labs 06_* / agr_finetune / agr_vla` aliases do this automatically.
