...
"""
RaiseBot — VLA policy server: host a checkpoint behind POST /act.
...
def build_app():
    ...
    app = FastAPI(title='RaiseBot VLA server')
...
def main():
    ap = argparse.ArgumentParser(description='RaiseBot VLA policy server')
