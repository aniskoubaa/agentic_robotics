...
"""
RaiseBot — VLA client factory: one switch picks the brain.
...
Config contract (see LOCAL_VS_REMOTE_VLA.md):
    ...
    VLA_LOCAL_CKPT  a fine-tuned output_dir; if unset, the local REFERENCE
                    ...
                    (scalexi/smolvla-raisebot-ripeness-ref) is downloaded
...
HF_REFERENCE = 'scalexi/smolvla-raisebot-ripeness-ref'
