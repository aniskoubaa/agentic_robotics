...
"""
RaiseBot — grasp server: a deterministic "fake grasp" for the sim.
...
from raisebot_tools import gz_utils
...
class GraspServer(Node):
    def __init__(self):
        ...
        self.declare_parameter('robot_model', 'raisebot_robot')  # gz model name
