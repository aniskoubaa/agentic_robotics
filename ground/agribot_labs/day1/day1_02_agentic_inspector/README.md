...
ros2 run agribot_labs agent.py          # press TAB after agribot_labs
```

**C. Direct python3 while editing** (servers must already be up):

```bash
cd ~/Dev_WS/raise_summer_school/AgriBot/raise_ros2_ws/src/agribot_labs/day1_02_agentic_inspector/starter
python3 agent.py
```
