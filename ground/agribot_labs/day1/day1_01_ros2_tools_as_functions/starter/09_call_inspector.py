#!/usr/bin/env python3
"""
AgriBot — Lab 1, Script 09 — VLM inspector.
...
WHAT  Send the current camera frame to an LLM with vision (GPT-4o)
      ...
      A live OpenCV window ("AgriBot - VLM inspector") shows the camera
...
║     agribot_tools/agribot_tools/inspector_server.py                   ║
║                                                                           ║
...
Before running this you need:
    ...
    ros2 run agribot_tools inspector_server   # in another terminal
