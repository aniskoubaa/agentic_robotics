...
```bash
ros2 run agribot_labs 01_drive_forward.py     # press TAB after agribot_labs
ros2 run agribot_labs 02_read_lidar.py        # Ctrl-C to quit
...
```bash
cd ~/Dev_WS/raise_summer_school/AgriBot/raise_ros2_ws/src/agribot_labs/day1_01_ros2_tools_as_functions/starter
