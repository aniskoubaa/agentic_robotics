...
**Lectures — `AgriBot/lectures/day2_l1_vlm_to_vla/`:**
- `AgriBot_LectureD2L1_VLM_to_VLA.tex` (**22 frames**, builds clean) +
...
- `AgriBot_D2_Comparative_VLA_Models.tex` (**23 frames**, builds clean) +
...
**Design docs — `AgriBot/raise_ros2_ws/src/agribot_labs/day2/`:**
...
`AgriBot/raise_ros2_ws/src/agribot_labs/day2/{day2_01_teleoperation_and_data, day2_02_vla_executor}/`.
...
- Each new starter gets an `XX_dN` **bashrc alias**; Day-2 uses `_d3` (Lab 2.1) /
  `_d4` (Lab 2.2). Add starters to `agribot_labs/setup.py` LABS (paths already
  listed) → `colcon build`.
