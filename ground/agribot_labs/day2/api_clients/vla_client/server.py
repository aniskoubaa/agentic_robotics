...
"""
AgriBot — VLA policy server: host a checkpoint behind POST /act.
...
def build_app():
    ...
    app = FastAPI(title='AgriBot VLA server')
...
def main():
    ap = argparse.ArgumentParser(description='AgriBot VLA policy server')
