...
# The AgriBot Reference Dataset — what we built and how
...
| Location | `AgriBot/datasets/raiseschool__raise_ripeness_sort_ref` (inside the repo — versioned with the code) |
...
ds = LeRobotDataset('raiseschool/raise_ripeness_sort_ref',
                    root='<repo>/AgriBot/datasets/raiseschool__raise_ripeness_sort_ref')
