...
"""
AgriBot — Lab 2.1, Script 03 — record demonstrations in LeRobot format.
...
Workflow (two terminals):
    Terminal 1:  ros2 run agribot_labs 01_teleop.py --task A
...
def main():
    ap = argparse.ArgumentParser(description='AgriBot LeRobot demo recorder')
