...
```
 ...
 camera into LeRobot format                     learns to copy the mapping
        ...
        AgriBot/datasets/…            ──►    ~/raise_checkpoints/smolvla_C_ref
```
...
`AgriBot/datasets/raiseschool__raise_ripeness_sort_ref/`.
...
~/raise_venvs/lerobot/bin/lerobot-train \
  ...
  --dataset.root=<repo>/AgriBot/datasets/raiseschool__raise_ripeness_sort_ref \
