...
`AgriBot/datasets/me__raise_ripeness_sort_team07`
(see a finished example with images: `AgriBot/datasets/raiseschool__raise_ripeness_sort_ref/`).
...
checkpoint** when present (see `AgriBot/checkpoints/README.md`). Expected:
...
~/raise_venvs/lerobot/bin/python3 \
  src/agribot_labs/day2/day2_02_vla_executor/evaluator/evaluate.py --task C --trials 10
```
...
- The dataset explained with images: `AgriBot/datasets/raiseschool__raise_ripeness_sort_ref/README.md`
- Sim manipulation layer + the 4 tunables: [`VERIFY_MANIPULATION.md`](./VERIFY_MANIPULATION.md)
- Checkpoint distribution: `AgriBot/checkpoints/README.md`
