...
def launch_setup(context, *args, **kwargs):
    ...
    pkg_worlds = get_package_share_directory('agribot_worlds')
    ...
    robot_xacro = os.path.join(pkg_description, 'urdf', 'agribot_robot.urdf.xacro')
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description='SDF in agribot_worlds/worlds/. Use greenhouse_2026_lite.sdf on CPU_ONLY.',
        ),
        ...
        # Resolve model://tomato_plant against agribot_worlds/share/.../meshes
        AppendEnvironmentVariable(
